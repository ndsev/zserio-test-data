...
import offsets.auto_array_offset.*;
import offsets.bit_offset.*;
import offsets.nested_offset.*;
import offsets.offset_in_choice.*;
import offsets.offset_in_nested_choice_in_template.*;
import offsets.offset_in_nested_choice.*;
import offsets.offset_in_nested_union_in_template.*;
import offsets.offset_in_nested_union.*;
